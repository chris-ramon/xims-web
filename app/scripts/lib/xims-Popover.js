...
var ximsPopoverSelectController = function($scope, $element, PopoverService) {
  var src = {};
...
var ximsPopoverController = function($scope, $element, PopoverService) {
  var src = {};
  $scope.PopoverService = PopoverService;
...
angular.module('ximsPopover', [])
  ...
  .directive('ximsPopover', function($templateCache, $compile) {
